...
cBruch& cBruch::operator - (const cBruch& rhs) {	// Operator - als Methode
...
cBruch::operator cKomplex() {
	return cKomplex((double)zaehl*1.1, (double)nenn*1.1);	// Zaehler mal 1.1 soll Realteil werden, Nenner entsprechend Imaginaer-Teil
}
